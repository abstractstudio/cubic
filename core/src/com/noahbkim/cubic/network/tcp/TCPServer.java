...
public class TCPServer implements Server {
	...
	public ArrayList<TCPHandler> handlers;
	public ArrayList<Thread> threads;
	public LinkedBlockingQueue<TCPHandlerMessage> queue;
	...
	public TCPServer() {
		...
		queue = new LinkedBlockingQueue<TCPHandlerMessage>();
		/* Create the socket. */
	...
	public void listen() {
		...
		while (alive) {
			...
			TCPHandler handler = new TCPHandler(handlers.size(), client, this);
	...
	public void serve() {
		...
		while (alive) {
			...
			TCPHandlerMessage message = null;
